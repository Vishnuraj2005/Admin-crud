...
import caro1 from "./images/carousel-1.jpg";
import caro2 from "./images/carousel-2.jpg";
import caro3 from "./images/carousel-3.jpg";
...
const Home = () => {
  ...
  return (
    <>
      <div id="carouselExampleCaptions" className="carousel slide" style={{paddingBottom:'50px'}}>
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item active">
            <img src={caro1}  className="d-block w-100" alt="Food" />
            <div className="carousel-caption d-none d-md-block">
              <h5>Delicious Food</h5>
              <p>Enjoy our tasty meals and fresh ingredients.</p>
            </div>
          </div>

          <div className="carousel-item">
            <img src={caro2} className="d-block w-100" alt="Food" />
            <div className="carousel-caption d-none d-md-block">
              <h5>Fresh Ingredients</h5>
              <p>Quality food made with fresh products.</p>
            </div>
          </div>

          <div className="carousel-item">
            <img src={caro3} className="d-block w-100" alt="Food" />
            <div className="carousel-caption d-none d-md-block">
              <h5>Best Taste</h5>
              <p>Experience the best flavors every day.</p>
            </div>
          </div>
